const dataset= ['1-13 r: gqdrspndrpsrjfjx',
...
for(let i=0; i<dataset.length;i++){
	let stepOne = dataset[i].split(' ');
	let min = stepOne[0].split('-')[0];
	let max = stepOne[0].split('-')[1];
	let character = stepOne[1].split(':')[0];
	let string = stepOne[2];
	let occurrences=string.split(character).length-1;
	if((occurrences<=max)&&(occurrences>=min)){
		count++;
		console.log(dataset[i]+" occurances: "+occurrences);
	}
}
console.log(count);
count=0;
for(let i=0; i<dataset.length;i++){
	let stepOne = dataset[i].split(' ');
	let posOne = stepOne[0].split('-')[0];
	let posTwo = stepOne[0].split('-')[1];
	let character = stepOne[1].split(':')[0];
	let string = stepOne[2];
	if((string[posOne-1]===character)^(string[posTwo-1]===character)){
		count++;
		console.log(dataset[i]+' pos1 '+string[posOne-1]+' pos2 '+string[posTwo-1]);
	}
}
console.log(count);