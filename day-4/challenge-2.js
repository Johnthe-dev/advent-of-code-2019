//Second challenge of Day 4 of the Advent of Code 2019.
...
function createArrayOfNonDescendingDigits(start, end) {
	...
	while (testValue<end) {
		...
		if ((testArray[0]===testArray[1] || testArray[1]===testArray[2] || testArray[2]===testArray[3] || testArray[3]===testArray[4] || testArray[4]===testArray[5])
			&& (parseInt(testArray[0])<= parseInt(testArray[1])
			...
			if((testArray[0]===testArray[1] && testArray[1]===testArray[2]) && !(testArray[3]===testArray[4] || testArray[4]===testArray[5])){

			} else if((testArray[1]===testArray[2] && testArray[2]===testArray[3]) && !(testArray[4]===testArray[5])) {

			} else if((testArray[2]===testArray[3] && testArray[3]===testArray[4]) && !(testArray[0]===testArray[1])){

			} else if((testArray[3]===testArray[4] && testArray[4]===testArray[5]) && !(testArray[0]===testArray[1] || testArray[1]===testArray[2])){

			} else if ((testArray[3]===testArray[4] && testArray[4]===testArray[5]) && (testArray[0]===testArray[1] && testArray[1]===testArray[2])) {

		} else if((testArray[0]===testArray[1] && testArray[1]===testArray[2] && testArray[2]===testArray[3]) && !(testArray[4]===testArray[5])) {
			}else {
